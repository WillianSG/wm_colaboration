...
def export_attractors_data(rcn, attractor_A, attractor_B):

    # Excitatory spike trains.

    _E_spk_trains = {key: value for key, value in rcn.E_mon.spike_trains().items() if key in attractor_A + attractor_B}
...
rcn.export_attractors_data(rcn = rcn, attractor_A = A1, attractor_B = A2)