...
# python3 test_conditional_activation.py --ba_amount 15 --i_amount 10 --i_stim_amount 20 --A2_cue_time 0.7 --attractors 3
...
timestamp_folder = make_timestamped_folder('../../../results/RCN_controlled_PS/')
...
for ba, gs_percentage, i_e_w, i_freq in parameter_combinations:
    ...
    rcn.run_net(duration = 3 + args.A2_cue_time)
