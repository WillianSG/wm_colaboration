...
for ba, gs_percentage, i_e_w, i_freq in parameter_combinations:
    ...
    # -- generic stimulus --
    # gss, free_time = generate_evenly_spaced_gss( gs_percentage, args.gs_freq, args.gs_length, args.pre_runtime,
    #                                                  args.gs_runtime )
    gss, free_time = generate_gss(gs_percentage, args.gs_length, args.pre_runtime, args.gs_runtime)
    ...
    rcn.set_stimulus_i(stimulus='flat_to_I', frequency=i_freq * Hz)
