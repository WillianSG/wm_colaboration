...
def plot_thresholds(rcn, attractors, show=True):
    ...
    l11 = ax11.plot(rcn.E_rec.x / second, f_u_a1, c='y', label='f(u)')
    ax11.tick_params(axis='y', labelcolor='y')
    ax12 = ax11.twinx()
    l12 = ax12.plot(rcn.E_rec.x / second, Vth_a1, c='g', label='u')
    ...
    l21 = ax21.plot(rcn.E_rec.x / second, f_u_a2, c='y', label='f(u)')
    ax21.tick_params(axis='y', labelcolor='y')
    ax22 = ax21.twinx()
    l22 = ax22.plot(rcn.E_rec.x / second, Vth_a2, c='g', label='u')
